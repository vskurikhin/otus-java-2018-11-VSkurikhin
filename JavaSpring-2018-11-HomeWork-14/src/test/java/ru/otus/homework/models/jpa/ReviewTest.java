...
class ReviewTest
{
    ...
    class WhenNewAllArgsConstructor
    {
        ...
        void createNew()
        {
            review = new Review(TEST_BID_13, TEST_COMMENT_NAME_13, null);
        }
        ...
        void defaults()
        {
            assertThat(review).hasFieldOrPropertyWithValue("id", TEST_BID_13);
            assertThat(review).hasFieldOrPropertyWithValue("review", TEST_COMMENT_NAME_13);
        }
        ...
        void testEquals()
        {
            ...
            Review expected = new Review(TEST_BID_13, TEST_COMMENT_NAME_13, null);
