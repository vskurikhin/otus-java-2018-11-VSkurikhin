...
class AuthorTest
{
    ...
    class WhenNewAllArgsConstructor
    {
        ...
        void createNew()
        {
            author = new Author(TEST_BID, TEST_FIRST_NAME, TEST_LAST_NAME);
        }
        ...
        void defaults()
        {
            assertThat(author).hasFieldOrPropertyWithValue("id", TEST_BID);
        ...
        void testEquals()
        {
            ...
            Author expected = new Author(TEST_BID, TEST_FIRST_NAME, TEST_LAST_NAME);
