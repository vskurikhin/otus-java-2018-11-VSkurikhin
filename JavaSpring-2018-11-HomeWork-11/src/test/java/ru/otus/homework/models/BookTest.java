...
class BookTest
{
    ...
    class WhenNewAllArgsConstructor
    {
        ...
        {
            book = new Book(
                TEST_BID, TEST_ISBN, TEST_TITLE, TEST_NUM, TEST_COPYRIGHT, Collections.emptyList(), genre
            );
        }
        ...
        void defaults()
        {
            assertThat(book).hasFieldOrPropertyWithValue("id", TEST_BID);
        ...
        void testEquals()
        {
            ...
            Book expected1 = new Book(
                BigInteger.ONE, TEST_ISBN, TEST_TITLE, TEST_NUM, TEST_COPYRIGHT, Collections.emptyList(), genre
            );
            Book expected2 = new Book(
                new BigInteger("1"), TEST_ISBN, TEST_TITLE, TEST_NUM, TEST_COPYRIGHT, Collections.emptyList(), genre
            );
